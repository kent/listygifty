...
- Business signup now stores the selected use case on the company profile for follow-up and segmentation.
- People CSV import tracks starts, completion counts, address counts, skipped rows, and failed attempts.
