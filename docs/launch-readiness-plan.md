...
3. Calendar and reminders
   ...
   - Web person detail can now download `.ics` calendar events for birthdays and milestones.
   - Web dashboard now surfaces upcoming list deadlines, birthdays, and milestones from the current workspace.
...
4. Purchase loop
   ...
   - Mobile gift detail now offers a direct Mark Purchased action when the saved gift has not changed.
...
- Web dashboard now shows the next upcoming gift dates across active lists and people.
...
- Mobile gift detail can now mark a saved gift purchased directly after purchase-link review.
...
- Web gift lists now support bulk status updates for currently visible gifts.
